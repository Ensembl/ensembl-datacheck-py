...
This module performs variation-specific BigBed checks.

Checks performed:
1. check_exist: Imported generic BigBed existence check.
2. check_validity: Imported generic BigBed validity check.
